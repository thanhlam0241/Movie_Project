...
parser.add_argument('--dataset', type=str, default='moviedb', help='which dataset to use')
...
parser.add_argument('--model_dir', type=str, default='../model_moviedb', help='directory to save model')
