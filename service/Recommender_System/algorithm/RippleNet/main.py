if __name__ == '__main__':
    ...
    n_user, n_item, n_entity, n_relation, train_data, test_data, kg, topk_data = data_process.pack_kg(kg_loader.ml1m_kg20k, negative_sample_threshold=4, split_ensure_positive=True)
