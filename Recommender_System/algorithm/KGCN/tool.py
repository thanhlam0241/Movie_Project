...
@logger('Build an undirected graph based on the knowledge graph structure ')
...
@logger('Construct an adjacency list based on the undirected graph of the knowledge graph, ', ('n_entity', 'neighbor_size'))
