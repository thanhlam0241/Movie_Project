...
np.random.seed(555)  # Seed random
...
data_info = load_data(args)  # load dataset
...
class Recommendation(QTableWidget):
    def __init__(self, parent=None, link=None):
        ...
        top_k, movie_top_k = predict(args, data_info, self.user)  # Đề xuất người dùng đến và trả lại chuỗi phim top_k
